...
const layers: Layer[] = [
    ...
    { id: 'bg-2', src: '/feature-section-1/F 1 - bg 2.webp', triggerPoint: 0.46, offsetY: 0 ,from: {
        opacity: 0,
    },
    to: {
        opacity: 0.5,
    ...
    { 
        ...
        to: {
            topLeft: { x: 1051/1500, y: 16/1000 },
            bottomRight: { x: 1458/1500, y: 984/1000 },
            blur: 60/1500,  // 动画后的 blur（相对于容器宽度）
            opacity: 0.6,
        },
    },
    
    // 聊天面板
    { id: 'chatPanel', src: '/feature-section-1/F 1 - chatPanel.webp', triggerPoint: 0.18, offsetY: 0 },
    ...
    // Message 动画组
    {
        ...
        delay: 0.04,
        offsetY: 50,
        opacityFrom: 0.4,  // 动画开始时突然变为此值，然后过渡到 1
        messages: [
            { id: 'message-0', src: '/feature-section-1/F 1 - message 0.webp',triggerPoint: 0.22 },
            { id: 'message-1', src: '/feature-section-1/F 1 - message 1.webp' },
            { id: 'message-2', src: '/feature-section-1/F 1 - message 2.webp' },
            { id: 'message-3', src: '/feature-section-1/F 1 - message 3.webp' },
            { id: 'message-4', src: '/feature-section-1/F 1 - message 4.webp' },
            { id: 'message-5', src: '/feature-section-1/F 1 - message 5.webp' },
            { id: 'message-6', src: '/feature-section-1/F 1 - message 6.webp' },
            { id: 'message-7', src: '/feature-section-1/F 1 - message 7.webp' },
            { id: 'message-8', src: '/feature-section-1/F 1 - message 8.webp' },
        ],
    },

    { id: 'chatBox', src: '/feature-section-1/F 1 - chatBox.webp', triggerPoint: 0, offsetY: 0 },
];
